        ...
        <div className="about-us-container">
          ...
          <div className="advantages">
            ...
            <div className="advantage">
              ...
              <p>
                Гарантия ах**енного результата. Мы готовы передать эстафетную
            ...
            <div className="advantage">
              ...
              <p>
                Наша методика преподавания. Мы против зубрёжки нудного
                материала, поэтому на каждую тему у нас есть свой козырь в
                рукаве. Жизненные истории, запоминающиеся картинки, яркое
                оформление — всё это избавит вас от скучного и бессмысленного
                заучивания правил.
              </p>
            </div>
          </div>
